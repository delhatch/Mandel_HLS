...
//------------  Draw MANDELBROT image  -------------------------------------------------------------
    ...
    for(x = 0; x < w; x++)
        for(y = 0; y < h; y++)
        {
           ...
           } while( (!is_ready0) && (!is_ready1) && (!is_ready2) && (!is_ready3) && (!is_ready4) && (!is_ready5) && (!is_ready6) && (!is_ready7));
           ...
           if( (is_ready2 != 0) && ( done == 0)  ) {
              ...
              if( (is_ready4 != 0) && ( done == 0)  ) {
              XMandel_engine_Set_pr( &Engine4, *((u32*)&pr) );
              XMandel_engine_Set_pi( &Engine4, *((u32*)&pi) );
              XMandel_engine_Start( &Engine4 );
              done = 1;
              xx4 = x; yy4 = y; started4 = 1;
           }
              if( (is_ready5 != 0) && ( done == 0)  ) {
              XMandel_engine_Set_pr( &Engine5, *((u32*)&pr) );
              XMandel_engine_Set_pi( &Engine5, *((u32*)&pi) );
              XMandel_engine_Start( &Engine5 );
              done = 1;
              xx5 = x; yy5 = y; started5 = 1;
           }
              if( (is_ready6 != 0) && ( done == 0)  ) {
              XMandel_engine_Set_pr( &Engine6, *((u32*)&pr) );
              XMandel_engine_Set_pi( &Engine6, *((u32*)&pi) );
              XMandel_engine_Start( &Engine6 );
              done = 1;
              xx6 = x; yy6 = y; started6 = 1;
           }
              if( (is_ready7 != 0) && ( done == 0)  ) {
              XMandel_engine_Set_pr( &Engine7, *((u32*)&pr) );
              XMandel_engine_Set_pi( &Engine7, *((u32*)&pi) );
              XMandel_engine_Start( &Engine7 );
              done = 1;
              xx7 = x; yy7 = y; started7 = 1;
           }
        }   // end of "for y"
    }   // end of "for x"
    return 0;
